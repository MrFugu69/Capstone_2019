...
# Challenge: 
One of the challenges for advancing Biological microscopy with the use of (*AI*) stems from the inability to sustain replicate images with identical characteristics. 
